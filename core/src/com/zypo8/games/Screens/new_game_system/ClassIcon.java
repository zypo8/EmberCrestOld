...
public class ClassIcon extends Actor {
    private final Sprite selectedSprite = new Sprite(new Texture(Gdx.files.internal("img/placeHolders/palladin.png")));
    private final Sprite sprite = new Sprite(new Texture(Gdx.files.internal("img/placeHolders/mithrilNeck.png")));
