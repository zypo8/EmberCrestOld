...
public class HUDStage extends Stage implements InputProcessor {
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        Gdx.app.log("HIT", String.valueOf(hitActor));
        if(hitActor != null && hitActor.getName() != null && hitActor.getName().equals("exp Bar")){
        ...
        if(hitInventorySlot != null){
            ...
            if (hitInventorySlot.getClass().getName().startsWith("com.zypo8.games.items")) {
                if (window != null) {
                    window.remove();
                }
                ...
                if(hitInventorySlot.getItem() != null) {
                    if(button == 0){
                        hitInventorySlot.getItem().firstOption();
                        if(hitInventorySlot.getItem() != null)
                            hitInventorySlot.getItem().getItemDescriptionWIndow().setZIndex(999999999);
                        return true;
                    }
                    else if(button == 1) {
                        if(hitInventorySlot.getItem().getClass().getName().length() == 36 &&
                                hitInventorySlot.getItem().getClass().getName().startsWith("com.zypo8.games.abilities.buffs.Buff")) {
                            Player.getEquipmentWindow().refreshStats();
                            return true;
                        }
                        if(hitInventorySlot.getItem() instanceof Buff){
                            ...
                            window = new InteractWindow(hitInventorySlot.getItem().getName(), Tools.getSkin());
    ...
    public boolean mouseMoved(int screenX, int screenY) {
        ...
        if(hitActor instanceof InventorySlot){
            ...
            if(item != null) {
                itemDescriptionWIndow = item.getItemDescriptionWIndow();
                if(!item.getItemDescriptionWIndow().isVisible()) {
                    ...
                    itemDescriptionWIndow.setVisible(true);
            ...
            if(hitInventorySlot.getTalent() != null){
                if(!hitInventorySlot.getTalent().getItemDescriptionWIndow().isVisible()) {
                    ...
                    addActor(hitInventorySlot.getTalent().getItemDescriptionWIndow());
                    System.out.println("YES");
                }
            }
        }
        ...
        if(hitActor != lastHitActor){
            if(lastHitActor instanceof InventorySlot){
                ...
                if(hitInventorySlot.getItem() != null){
                    ...
                    hitInventorySlot.getItem().getItemDescriptionWIndow().remove();
                    System.out.println("NO");
                }
                if(hitInventorySlot.getTalent() != null){
                    hitInventorySlot.getTalent().getItemDescriptionWIndow().setVisible(false);
                    hitInventorySlot.getTalent().getItemDescriptionWIndow().remove();
                    System.out.println("NO");
                }
            }
        }
