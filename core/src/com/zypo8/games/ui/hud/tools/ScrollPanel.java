...
public class ScrollPanel extends WidgetGroup {
    ...
    public ScrollPanel (Actor widget, Skin skin) {
        this(widget, skin.get(ScrollPane.ScrollPaneStyle.class));
    }
    public ScrollPanel (Actor widget, ScrollPane.ScrollPaneStyle style) {
        ...
        addCaptureListener(new InputListener() {
            ...
            public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
                ...
                if (getStage() != null) getStage().setScrollFocus(ScrollPanel.this);
