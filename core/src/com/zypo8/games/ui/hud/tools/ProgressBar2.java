...
public class ProgressBar2 extends Widget implements Disableable {
    ...
    public ProgressBar2 (float min, float max, float stepSize, boolean vertical, Skin skin) {
        this(min, max, stepSize, vertical, skin.get("default-" + (vertical ? "vertical" : "horizontal"), com.badlogic.gdx.scenes.scene2d.ui.ProgressBar.ProgressBarStyle.class));
    }

    public ProgressBar2 (float min, float max, float stepSize, boolean vertical, Skin skin, String styleName) {
        this(min, max, stepSize, vertical, skin.get(styleName, com.badlogic.gdx.scenes.scene2d.ui.ProgressBar.ProgressBarStyle.class));
    }
     ...
     * @param style the {@link com.badlogic.gdx.scenes.scene2d.ui.ProgressBar.ProgressBarStyle} */
    public ProgressBar2 (float min, float max, float stepSize, boolean vertical, com.badlogic.gdx.scenes.scene2d.ui.ProgressBar.ProgressBarStyle style) {
